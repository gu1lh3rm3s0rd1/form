...
<head>
  ...
  <header class="top auto ctr">
    <img class="ctr" src="img/logo-chiaperini.png" alt="img"><p class="white" style="margin-left: 10px; font-size: 25px; margin-top: 0; margin-bottom: 0rem;">PÓS VENDA TECHTO</p>
  </header>
</head>
...
<form action="" method="get">
  <?php
    try{
      ...
      $query = "SELECT CODIGO_CLIENTE, NOME, ENDERECO, CIDADE, ESTADO, CGC_CNPJ, BAIRRO 
        FROM AUGC0301 WHERE CODIGO_CLIENTE = '$sql'";
      ...
      <form action="submit.php" method="post">
        ...
        <div class="flex">
          ...
          <div class="box2">
            ...
            <input class="info-cnpj" id="cnpj" style="opacity: 0.7;" type="text" name="cnpj" readonly value="<?php echo utf8_encode($cpf); ?>" placeholder="CPF/CNPJ">
          </div>
